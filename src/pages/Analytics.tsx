    ...
    <div className="px-3 py-6 md:px-6 min-h-full pb-28 md:pb-6">
      ...
      {(summary.tradeAdds > 0 || summary.tradeRefunds > 0) && (
        <div className="grid grid-cols-2 gap-3 mb-6">
          <div className="bg-blue-50 border border-blue-100 p-4 rounded-[24px] shadow-sm text-center">
            <div className="text-[10px] font-bold uppercase tracking-widest text-blue-500 mb-1">Trade: Cust Adds</div>
            <p className="text-lg font-serif text-blue-900">{formatRupiah(summary.tradeAdds)}</p>
          </div>
          <div className="bg-orange-50 border border-orange-100 p-4 rounded-[24px] shadow-sm text-center">
            <div className="text-[10px] font-bold uppercase tracking-widest text-orange-500 mb-1">Trade: Cust Rcv</div>
            <p className="text-lg font-serif text-orange-900">{formatRupiah(summary.tradeRefunds)}</p>
          </div>
        </div>
      )}
